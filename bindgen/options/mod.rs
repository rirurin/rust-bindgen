...
options! {
    ...
    /// Whether to generate explicit struct layouts (#[ensure_layout] and #[field_offset]) 
    generate_ensure_layout_attributes: bool {
        default: true,
        methods: {
            /// Set generate_ensure_layout_attributes
            pub fn generate_ensure_layout_attributes(mut self) -> Builder {
                self.options.generate_ensure_layout_attributes = true;
                self
            }
        },
        as_args: "--generate-ensure-layout-attributes",
    },
    /// Whether to remove autogenerated fields created by Ghidra (e.g field1_0x8)
    remove_ghidra_autogenerated_fields: bool {
        default: true,
        methods: { 
            /// Set remove_ghidra_autogenerated_fields
            pub fn remove_ghidra_autogenerated_fields(mut self) -> Builder {
                self.options.remove_ghidra_autogenerated_fields = true;
                self
            }
        },
        as_args: "--remove-ghidra-autogenerated-fields",
    },
}
